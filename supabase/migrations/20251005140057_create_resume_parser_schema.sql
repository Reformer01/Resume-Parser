/*
  ...
  ## Overview
  Creates the complete database structure for the Resume Parser application,
  including tables for storing parsed resumes, parsing history, and extracted entities.

  ## New Tables

  ### `resumes`
  Stores the main resume data and metadata
  - `id` (uuid, primary key) - Unique identifier for each resume
  - `user_id` (uuid) - Reference to authenticated user (for future auth implementation)
  - `file_name` (text) - Original filename of uploaded resume
  - `file_type` (text) - File format (pdf, docx, txt)
  - `file_size` (integer) - File size in bytes
  - `raw_text` (text) - Extracted raw text from resume
  - `storage_path` (text, nullable) - Path to stored file in Supabase storage
  - `parsing_status` (text) - Status: pending, processing, completed, failed
  - `confidence_score` (numeric, nullable) - Overall parsing confidence (0-100)
  - `created_at` (timestamptz) - Timestamp of upload
  - `updated_at` (timestamptz) - Last update timestamp

  ### `parsed_data`
  Stores structured data extracted from resumes
  - `id` (uuid, primary key) - Unique identifier
  - `resume_id` (uuid, foreign key) - Reference to resumes table
  - `full_name` (text, nullable) - Extracted full name
  ...
  - `portfolio_url` (text, nullable) - Personal website/portfolio
  - `summary` (text, nullable) - Professional summary/objective
  - `total_years_experience` (numeric, nullable) - Calculated years of experience
  - `created_at` (timestamptz) - Creation timestamp
  - `updated_at` (timestamptz) - Last update timestamp

  ### `skills`
  Stores extracted skills with categorization
  - `id` (uuid, primary key) - Unique identifier
  - `resume_id` (uuid, foreign key) - Reference to resumes table
  - `skill_name` (text) - Name of the skill
  - `category` (text, nullable) - Skill category (technical, soft, language, etc.)
  - `proficiency_level` (text, nullable) - Beginner, intermediate, advanced, expert
  - `years_experience` (numeric, nullable) - Years of experience with skill
  - `confidence` (numeric, nullable) - Extraction confidence score (0-100)
  - `created_at` (timestamptz) - Creation timestamp
  ...
  - `id` (uuid, primary key) - Unique identifier
  - `resume_id` (uuid, foreign key) - Reference to resumes table
  - `company_name` (text) - Name of company/organization
  ...
  - `description` (text, nullable) - Job responsibilities and achievements
  ...
  - `id` (uuid, primary key) - Unique identifier
  - `resume_id` (uuid, foreign key) - Reference to resumes table
  - `institution_name` (text) - Name of school/university
  - `degree` (text) - Degree type (Bachelor's, Master's, PhD, etc.)
  - `field_of_study` (text, nullable) - Major/field of study
  - `location` (text, nullable) - Institution location
  - `start_date` (date, nullable) - Start date
  - `end_date` (date, nullable) - Graduation date
  - `gpa` (text, nullable) - GPA or grade
  - `honors` (text, nullable) - Honors, awards, distinctions
  ...
  - `issuing_organization` (text, nullable) - Organization that issued certification
  - `issue_date` (date, nullable) - Date received
  - `expiry_date` (date, nullable) - Expiration date (if applicable)
  - `credential_id` (text, nullable) - Certification ID/credential number
  - `credential_url` (text, nullable) - Verification URL
  - `created_at` (timestamptz) - Creation timestamp

  ## Security
  - Enable Row Level Security (RLS) on all tables
  - Add policies for public insert (for demo purposes)
  - Add policies for users to read their own data
  - Future: Add user authentication and ownership policies
  ...
  - Default values provided where appropriate to prevent null errors
*/
